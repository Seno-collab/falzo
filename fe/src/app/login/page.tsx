    ...
    <main className="login-page">
      ...
      <section className="login-layout">
        <div className="login-story">
          ...
          <p className="eyebrow">
            <span aria-hidden="true">●</span> THE LOBBY IS OPEN
          </p>
          <h1>Good games start with good company.</h1>
          <p>
            Sign in once, then bring Falzo to the next dinner, road trip, or
            quiet night that needs a little chaos.
          </p>
        ...
        <div className="auth-card">
          ...
          <p className="muted">
            Create a player account, sign in with your password, or continue
            with Google.
          </p>
          <PasswordAuthForm />
